...
const ProductManagement = () => {
  ...
  const [newProduct, setNewProduct] = useState({ name: '', price: '', stockQuantity: '', description: '', image: '', category: 'General' });
  ...
  const generateAIDescription = async () => {
    ...
    try {
      ...
      console.error(err);
      const serverMsg = err.response?.data?.message || 'Failed to generate description';
    ...
    <>
      <style>{`
        ...
        :root {
          --indigo: #3E3A9E;
          --indigo-light: #5B57C2;
          --indigo-glow: rgba(62,58,158,0.14);
          --cream: #FCFBF9;
          --deep: #181430;
          --muted: #4B4870;
          --card-bg: #FFFFFF;
          --border-soft: #E9E6F4;
          --shadow-card: 0 4px 24px rgba(24,20,48,0.07);
          --shadow-hover: 0 8px 32px rgba(24,20,48,0.11);
        }
        ...
        .ds-pm-root::before {
          ...
          background-image:
            linear-gradient(rgba(62,58,158,0.03) 1px, transparent 1px),
            linear-gradient(90deg, rgba(62,58,158,0.03) 1px, transparent 1px);
        ...
        .ds-pm-title span { color: var(--indigo); }
        ...
        .ds-pm-badge {
          ...
          box-shadow: 0 4px 14px var(--indigo-glow); flex-shrink: 0;
        }
        ...
        .ds-select {
          ...
          background-color: #FCFBF9; padding-right: 2.2rem;
          -webkit-appearance: none;
        }
        .ds-input::placeholder, .ds-textarea-f::placeholder { color: #B3AECB; }
        ...
        .ds-img-preview-empty {
          ...
          color: #B3AECB; font-size: 0.75rem;
        }
        ...
        .ds-btn-primary:hover { transform: translateY(-1px); box-shadow: 0 8px 22px rgba(62,58,158,0.3); }
        ...
        .ds-count-badge {
          ...
          background: #F0EDFA; color: var(--muted);
        }
        ...
        .ds-table th {
          ...
          background: #FCFBF9; border-bottom: 1px solid var(--border-soft);
          white-space: nowrap;
        }
        .ds-table td {
          padding: 0.9rem 1.2rem;
          font-size: 0.9rem; color: var(--deep);
          border-bottom: 1px solid #F0EDFA; vertical-align: middle;
        }
        .ds-table tr:last-child td { border-bottom: none; }
        .ds-table tbody tr { transition: background 0.15s; }
        .ds-table tbody tr:hover { background: #FCFBF9; }
        ...
        .ds-prod-img-placeholder {
          width: 42px; height: 42px; border-radius: 10px;
          background: #F0EDFA; border: 1.5px solid var(--border-soft);
        ...
        .ds-cat-badge {
          ...
          background: rgba(62,58,158,0.08);
          color: var(--indigo);
          border: 1px solid rgba(62,58,158,0.2);
        }
        ...
        .ds-btn-edit:hover { border-color: var(--indigo); color: var(--indigo); }
          ...
          <div className="ds-pm-grid">
            ...
            <div className="ds-form-card">
              ...
              <form onSubmit={onAddProduct}>
                ...
                <div className="ds-field">
                  <label className="ds-label">Available Quantity</label>
                  <div className="ds-input-wrap">
                    <span className="ds-input-icon">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <input type="number" min="0" className="ds-input" placeholder="0" value={newProduct.stockQuantity} onChange={e => setNewProduct({ ...newProduct, stockQuantity: e.target.value })} required />
                  </div>
                </div>
                ...
                <div className="ds-field">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.6rem' }}>
                    <label className="ds-label" style={{ margin: 0 }}>Description</label>
                    <button 
                      type="button" 
                      onClick={generateAIDescription} 
                      disabled={isGenerating}
                      style={{ 
                        fontSize: '0.75rem', background: '#FF4500', border: 'none', 
                        color: 'white', padding: '5px 12px', borderRadius: '6px', cursor: 'pointer',
                        fontWeight: 'bold', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '5px',
                        boxShadow: '0 4px 12px rgba(255,69,0,0.3)', transition: 'all 0.2s'
                      }}
                  ...
                  <tbody>
                    {products.length === 0 ? (
                      ...
                      <tr key={p._id}>
                        ...
                        <td>
                          <span className="ds-cat-badge" style={{
                            background: Number(p.stockQuantity) > 0 ? 'rgba(22,163,74,0.08)' : 'rgba(220,38,38,0.08)',
                            color: Number(p.stockQuantity) > 0 ? '#15803D' : '#DC2626',
                            borderColor: Number(p.stockQuantity) > 0 ? 'rgba(22,163,74,0.2)' : 'rgba(220,38,38,0.2)'
                          }}>
