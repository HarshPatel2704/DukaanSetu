...
const AdminDashboard = ({ defaultTab = 'stats' }) => {
  ...
  const roleBadgeStyle = (role) => {
    if (role === 'admin') return { background: 'rgba(62,58,158,0.12)', color: '#3E3A9E', border: '1px solid rgba(62,58,158,0.3)' };
    if (role === 'shopkeeper') return { background: 'rgba(59,130,246,0.1)', color: '#3B82F6', border: '1px solid rgba(59,130,246,0.25)' };
    return { background: 'rgba(75,72,112,0.1)', color: '#4B4870', border: '1px solid rgba(75,72,112,0.2)' };
  };
    ...
    <>
      <style>{`
        ...
        .ds-admin-root::before {
          ...
          background-image: linear-gradient(rgba(62,58,158,0.03) 1px, transparent 1px),
        ...
        .ds-admin-title span { color: var(--indigo); }
        ...
        .ds-tab:hover { color: var(--deep); background: rgba(62,58,158,0.05); }
        ...
        .ds-stat-card.indigo::before { background: linear-gradient(90deg, var(--indigo), var(--indigo-light)); }
        ...
        .ds-stat-icon.indigo { background: rgba(62,58,158,0.1); }
        .ds-stat-icon.indigo svg { stroke: var(--indigo); }
        ...
        .ds-btn-link:hover { color: var(--indigo); }
        ...
        .ds-input::placeholder, .ds-textarea-field::placeholder { color: #B3AECB; }
        .ds-input:focus, .ds-textarea-field:focus { border-color: var(--indigo); background: #fff; box-shadow: 0 0 0 4px var(--indigo-glow); }
        ...
        .ds-pop-rank.bronze { background: linear-gradient(135deg, #D64545, #FF8A8A); box-shadow: none; }
          ...
          {activeTab === 'stats' && stats && (
            <div className="ds-fade">
              <div className="ds-stat-grid">
                <div className="ds-stat-card indigo">
                  <div className="ds-stat-icon indigo">
                  ...
                  <tbody>
                    {products.map(p => (
                      <tr key={p._id}>
                        ...
                        <td>
                          <span className="ds-badge" style={{ background: 'rgba(62,58,158,0.08)', color: 'var(--indigo)', border: '1px solid rgba(62,58,158,0.2)' }}>{p.category}</span>
                        </td>
