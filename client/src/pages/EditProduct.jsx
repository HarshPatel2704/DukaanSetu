...
const EditProduct = () => {
  ...
  const [formData, setFormData] = useState({ name: '', price: '', stockQuantity: '', description: '', image: '', category: '' });
    ...
    <>
      <style>{`
        ...
        :root {
          --indigo: #3E3A9E;
          --indigo-light: #5B57C2;
          --indigo-glow: rgba(62,58,158,0.15);
          --cream: #FCFBF9;
          --deep: #181430;
          --muted: #4B4870;
          --card-bg: #FFFFFF;
          ...
          --shadow-hover: 0 12px 36px rgba(24,20,48,0.11);
        }
        ...
        .ds-blob-1 { width: 420px; height: 420px; background: radial-gradient(circle, rgba(62,58,158,0.10) 0%, transparent 70%); top: -140px; right: -100px; animation: floatBlob 8s ease-in-out infinite; }
        ...
        .ds-ep-brand-icon {
          ...
          box-shadow: 0 6px 20px var(--indigo-glow); margin-bottom: 0.9rem;
        }
        ...
        .ds-ep-title span { color: var(--indigo); }
        ...
        .ds-alert.error   { background: #F0ECFC; border: 1px solid rgba(62,58,158,0.3); color: #D64545; animation: shake 0.4s ease; }
        ...
        .ds-img-preview-wrap {
          ...
          background: #FCFBF9; margin-bottom: 1.75rem;
          height: 200px; position: relative;
          display: flex; align-items: center; justify-content: center;
          transition: border-color 0.2s;
        }
        .ds-img-preview-wrap:hover { border-color: var(--indigo-light); }
        ...
        .ds-btn-save {
          ...
          box-shadow: 0 5px 18px var(--indigo-glow);
        ...
        .ds-btn-save:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 10px 26px rgba(62,58,158,0.32); }
        .ds-btn-save:disabled { opacity: 0.7; cursor: not-allowed; }

        .ds-btn-cancel {
          padding: 0.95rem 1.5rem;
          border: 1.5px solid var(--border-soft);
          background: #FCFBF9; color: var(--muted);
            ...
            <form onSubmit={onSubmit}>
              ...
              <div className="ds-field">
                ...
                <div className="ds-input-wrap">
                  ...
                  <input
                    type="number" name="stockQuantity" min="0" className="ds-input"
                    placeholder="0" value={formData.stockQuantity} onChange={onChange} required
                  />
                </div>
              </div>
              ...
              {/* Description */}
              <div className="ds-field">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '0.48rem' }}>
                  ...
                  <button 
                    ...
                    style={{ 
                      fontSize: '0.7rem', background: 'var(--indigo-glow)', border: '1px solid var(--indigo)', 
                      color: 'var(--indigo)', padding: '2px 8px', borderRadius: '4px', cursor: 'pointer',
                      fontWeight: 600, textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '4px'
                    }}
                  >
                    {isGenerating ? '...' : (
              ...
              <div className="ds-actions">
                ...
                <button type="button" className="ds-btn-cancel" onClick={() => navigate('/product-management')}>
                  Cancel
                </button>
              </div>
