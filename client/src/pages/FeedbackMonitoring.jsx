  ...
  return (
    <>
      <style>{`
        ...
        .ds-fb-title span { color: var(--indigo); }
        ...
        .ds-breakdown-bar-bg {
          ...
          background: #EDEBFB; overflow: hidden;
        }
        .ds-breakdown-bar {
        ...
        .ds-review-card.r5::before, .ds-review-card.r4::before { background: linear-gradient(180deg, var(--indigo), var(--indigo-light)); }
        .ds-review-card.r3::before { background: linear-gradient(180deg, #FF6B6B, #FFB3B3); }
        ...
        .ds-review-quote::before {
          ...
          font-family: 'Playfair Display', serif;
          font-size: 1.6rem; color: var(--indigo); opacity: 0.35;
          ...
          <div className="ds-reviews-grid">
            {reversed.length === 0 ? (
              ...
              >
                ...
                {r.orderId?.products && (
                  <div style={{ fontSize: '0.75rem', color: 'var(--muted)', background: '#FCFBF9', padding: '0.5rem', borderRadius: '8px' }}>
