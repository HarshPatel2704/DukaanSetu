    ...
    <>
      <style>{`
        ...
        .ds-blob-1 {
          ...
          background: radial-gradient(circle, rgba(62,58,158,0.13) 0%, transparent 70%);
        ...
        .ds-blob-3 {
          ...
          background: radial-gradient(circle, rgba(62,58,158,0.08) 0%, transparent 70%);
          top: 40%; left: 60%;
        ...
        .ds-login-root::before {
          ...
          inset: 0;
          background-image:
            linear-gradient(rgba(62,58,158,0.04) 1px, transparent 1px),
            linear-gradient(90deg, rgba(62,58,158,0.04) 1px, transparent 1px);
        ...
        .ds-input::placeholder { color: #B3AECB; }
