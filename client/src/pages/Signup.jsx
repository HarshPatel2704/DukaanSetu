...
const Signup = ({ handleLogin }) => {
  ...
  const onSubmit = async (e) => {
    ...
    if (!/^[a-zA-Z\s]+$/.test(formData.name)) {
      setError('Name can only contain characters');
      return;
    }
    try {
      // const res = await axios.post('http://localhost:5000/api/auth/signup', formData);
      const res = await axios.post(
        'https://dukaansetu-backend.onrender.com/api/auth/signup',
        formData
      );
    ...
    <>
      <style>{`
        ...
        :root {
          --indigo: #3E3A9E;
          --indigo-light: #5B57C2;
          --indigo-glow: rgba(62, 58, 158, 0.18);
          --cream: #FCFBF9;
          --deep: #181430;
          --muted: #4B4870;
          --card-bg: #FFFFFF;
          --border: rgba(62, 58, 158, 0.15);
          --shadow: 0 32px 80px rgba(24, 20, 48, 0.12);
        }
        ...
        .ds-blob-1 { width: 520px; height: 520px; background: radial-gradient(circle, rgba(62,58,158,0.13) 0%, transparent 70%); top: -180px; right: -120px; animation: floatBlob 8s ease-in-out infinite; }
        ...
        .ds-blob-3 { width: 200px; height: 200px; background: radial-gradient(circle, rgba(62,58,158,0.08) 0%, transparent 70%); top: 40%; left: 60%; animation: floatBlob 12s ease-in-out infinite 2s; }
        ...
        .ds-su-root::before {
          ...
          background-image: linear-gradient(rgba(62,58,158,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(62,58,158,0.04) 1px, transparent 1px);
        ...
        .ds-card::before {
          ...
          background: linear-gradient(90deg, var(--indigo), var(--indigo-light), #FF8A8A);
        ...
        /* Error */
        .ds-error {
          background: #F0ECFC; border: 1px solid rgba(62,58,158,0.3);
          border-radius: 10px; padding: 0.7rem 1rem;
          color: #D64545; font-size: 0.85rem; font-weight: 500;
        ...
        .ds-input, .ds-textarea, .ds-select {
          ...
          border: 1.5px solid #E9E6F4; border-radius: 11px;
          font-family: 'DM Sans', sans-serif; font-size: 0.92rem;
          color: var(--deep); background: #FCFBF9;
        ...
        .ds-input::placeholder, .ds-textarea::placeholder { color: #B3AECB; }
        ...
        .ds-role-card {
          ...
          background: #FCFBF9; transition: all 0.2s;
          display: flex; flex-direction: column; align-items: center; gap: 0.4rem;
        }
        .ds-role-card:hover { border-color: var(--indigo-light); background: #F7F4FF; }
        .ds-role-card.active {
          border-color: var(--indigo); background: #EEEAFC;
          box-shadow: 0 0 0 3px var(--indigo-glow);
        }
        .ds-role-card-icon { width: 30px; height: 30px; border-radius: 8px; background: #EDEBFB; display: flex; align-items: center; justify-content: center; transition: background 0.2s; }
        .ds-role-card.active .ds-role-card-icon { background: linear-gradient(135deg, var(--indigo), var(--indigo-light)); }
        ...
        .ds-role-card.active .ds-role-card-label { color: var(--indigo); font-weight: 600; }

        /* Secret code field */
        .ds-secret-wrap {
          background: #F7F4FF; border: 1.5px solid rgba(62,58,158,0.25);
          border-radius: 12px; padding: 1rem 1.1rem;
          margin-bottom: 1.2rem;
          animation: fadeIn 0.35s ease both;
        }
        .ds-secret-label { font-size: 0.78rem; font-weight: 600; color: var(--indigo); text-transform: uppercase; letter-spacing: 0.08em; display: flex; align-items: center; gap: 0.4rem; margin-bottom: 0.55rem; }
        ...
        .ds-btn:hover { transform: translateY(-2px); box-shadow: 0 12px 32px rgba(62,58,158,0.35); }
        .ds-btn:active { transform: translateY(0); }

        /* Trust + login link */
        .ds-trust { display: flex; align-items: center; justify-content: center; gap: 1.5rem; margin-top: 1.75rem; padding-top: 1.4rem; border-top: 1px solid #E9E6F4; animation: fadeIn 0.5s ease 0.45s both; }
        .ds-trust-item { display: flex; align-items: center; gap: 0.35rem; font-size: 0.74rem; color: #8C88AD; font-weight: 500; }
        .ds-trust-item svg { width: 13px; height: 13px; fill: var(--indigo); opacity: 0.8; }
        ...
        .ds-login-link a { color: var(--indigo); font-weight: 600; text-decoration: none; transition: opacity 0.2s; }
