    ...
    <>
      <style>{`
        ...
        :root {
          ...
          --brand-light: #5B57C2;
          --brand-soft: #EDEBFB;
          --brand-glow: rgba(62, 58, 158, 0.16);
          --ink: #181430;
          --ink-soft: #4B4870;
          --muted: #8C88AD;
          --nav-bg: rgba(252, 251, 249, 0.92);
          --nav-border: rgba(24, 20, 48, 0.08);
        }
        ...
        .ds-nav {
          ...
          box-shadow: 0 1px 0 rgba(255,255,255,0.6), 0 8px 30px rgba(24, 20, 48, 0.07);
        }
        ...
        .ds-nav::before {
          ...
          display: block;
          height: 3px;
          background: linear-gradient(90deg, var(--brand), var(--brand-light), #FF8A8A, var(--brand));
        ...
        .ds-nav-link:hover { color: var(--ink); background: rgba(24,20,48,0.05); }
        .ds-nav-link:hover svg { opacity: 1; }
        .ds-nav-link.active {
          color: var(--brand);
          background: var(--brand-soft);
        }
        .ds-nav-link.active svg { opacity: 1; stroke: var(--brand); }

        /* Divider between nav sections */
        .ds-nav-sep {
          width: 1px; height: 22px;
          background: rgba(24,20,48,0.1);
          margin: 0 0.5rem;
          flex-shrink: 0;
        }
        ...
        .ds-user-name strong { color: var(--ink); }
        ...
        .ds-btn-logout:hover { background: var(--brand-soft); border-color: var(--brand); color: var(--brand); }

        .ds-btn-login {
          padding: 0.4rem 0.9rem;
          border: 1.5px solid rgba(24,20,48,0.15);
          background: transparent;
          color: var(--ink-soft);
          border-radius: 10px;
          font-family: 'DM Sans', sans-serif;
        ...
        .ds-btn-login:hover { border-color: rgba(24,20,48,0.35); color: var(--ink); background: rgba(24,20,48,0.04); }
        ...
        .ds-btn-signup {
          ...
          box-shadow: 0 3px 14px var(--brand-glow);
          white-space: nowrap;
        }
        .ds-btn-signup:hover { transform: translateY(-1px); box-shadow: 0 8px 22px rgba(62,58,158,0.3); color: white; }
        ...
        .ds-mobile-menu {
          ...
          border-top: 1px solid rgba(24,20,48,0.06);
          background: #FCFBF9;
          gap: 0.25rem;
        ...
        .ds-mobile-link:hover { color: var(--ink); background: rgba(24,20,48,0.05); }
        .ds-mobile-link.active { color: var(--brand); background: var(--brand-soft); }
        .ds-mobile-divider { height: 1px; background: rgba(24,20,48,0.08); margin: 0.5rem 0; }
          ...
          {user ? (
            <div style={{ padding: '0.25rem 0.75rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
                <div className="ds-user-avatar">{user.name?.charAt(0).toUpperCase()}</div>
                <span style={{ color: 'var(--ink)', fontSize: '0.875rem', fontWeight: 500 }}>{user.name}</span>
                <span className="ds-role-badge">{user.role}</span>
              </div>
