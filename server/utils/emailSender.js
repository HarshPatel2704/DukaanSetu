    ...
    const htmlContent = `
        ...
        <head>
            ...
            <style>
                ...
                .main { background-color: #ffffff; margin: 20px auto; width: 100%; max-width: 600px; border-spacing: 0; color: #4a4a4a; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05); }
                .header { background: linear-gradient(135deg, #007bff 0%, #0056b3 100%); padding: 40px 20px; text-align: center; }
                .header h1 { color: #ffffff !important; margin: 0; font-size: 28px; font-weight: 700; }
                ...
                .feature-box { background-color: #f0f7ff; border-left: 4px solid #007bff; padding: 20px; margin-bottom: 25px; border-radius: 4px; }
                .feature-box p { margin: 0; font-weight: 500; color: #0056b3; }
                .button-container { text-align: center; margin: 35px 0; }
                .button { background-color: #007bff; color: #ffffff !important; padding: 15px 35px; text-decoration: none; border-radius: 50px; font-weight: bold; font-size: 16px; display: inline-block; }
                .footer { background-color: #f1f3f5; padding: 30px; text-align: center; font-size: 12px; color: #999999; }
            </style>
        </head>
        <body>
            <center class="wrapper">
                <table class="main">
                    <tr><td class="header"><h1>DukaanSetu</h1></td></tr>
                    <tr>
                        <td class="content">
                            <h2>Hello, ${user.name}!</h2>
                            <p>Welcome to <strong>DukaanSetu</strong> — the bridge between local shops and your neighborhood.</p>
                            <div class="feature-box"><p>${roleDescription}</p></div>
                    ...
                    <tr><td class="footer"><p>&copy; ${new Date().getFullYear()} DukaanSetu. All rights reserved.</p></td></tr>
                </table>
            </center>
        </body>
        </html>
...
const sendOrderConfirmationEmail = async (user, order) => {
    ...
    const htmlContent = `
        ...
        <body>
            <center class="wrapper">
                <table class="main">
                    <tr><td class="header"><h1>Order Placed Successfully! 🎉</h1></td></tr>
                    <tr>
                        <td class="content">
                            <h2>Hi ${user.name},</h2>
                            ...
                            <table class="order-summary">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td style="padding: 20px 10px 10px; text-align: right;">₹${order.totalAmount.toFixed(2)}</td>
                                    </tr>
                                </tfoot>
                            </table>
